...
export function CompletionTaskBuilder({
  ...
  const handleInstructionChange = (e: any) => {
    editTask<ListeningCompletionTask>(index, { ...task, instructions: e });
  };
  ...
  const handleTaskTypeChange = (
    taskType: ListeningCompletionTask["taskType"],
  ) => {
    editTask<ListeningCompletionTask>(index, {
      ...task,
      taskType,
            ...
            <RadioGroup
              ...
              onValueChange={(value) =>
                handleTaskTypeChange(
                  value as ListeningCompletionTask["taskType"],
                )
              }
