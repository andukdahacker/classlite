...
interface ReviewListeningExerciseProps {
  exercise: ListeningExercise;
  submission: Submission;
}

function ReviewListeningExercise({
  exercise,
  submission,
}: ReviewListeningExerciseProps) {
        ...
        <Tabs defaultValue="material" className="h-full flex flex-col">
          ...
          <TabsContent value="material" className="flex-grow overflow-y-auto">
            <Card className="h-full">
              <CardHeader>
                <CardTitle>{exercise.file?.fileName}</CardTitle>
              </CardHeader>
              <CardContent>
                {exercise.file?.url && (
                  <audio controls src={exercise.file.url} className="w-full">
...
export { ReviewListeningExercise };
