...
import type { ExerciseType } from "@workspace/types";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
function ExerciseTable() {
  ...
  const { mutate: createExericse, isPending: isPendingCreateExercise } =
    useCreateExercise({
      onSuccess: (data) => {
        navigate(`/dashboard/exercises/${data.exercise.id}/edit`);
      },
    });
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem
                            onSelect={() => {
                              navigate(`/dashboard/exercises/${e?.id}`);
                            }}
                          >
                          ...
                          <DropdownMenuItem
                            onSelect={() => {
                              navigate(`/dashboard/exercises/${e?.id}/edit`);
                            }}
                          >
                            <div className="flex flex-row gap-2 items-center">
                              <EditIcon />
