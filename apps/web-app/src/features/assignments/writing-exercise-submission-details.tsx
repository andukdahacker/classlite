...
import { Comment } from "@/core/components/editor/comment/comment";
import "@/core/components/editor/comment/comment.css";
import { CommentClickPlugin } from "@/core/components/editor/comment/comment_click.plugin";
import { CommentHighlightPlugin } from "@/core/components/editor/comment/comment_highlight.plugin";
import { OverlappingCommentHighlightPlugin } from "@/core/components/editor/comment/overlapping_comment_highlight.plugin";
...
interface WritingExerciseSubmissionDetailsProps {
  exercise: Exercise;
...
function WritingExerciseSubmissionDetails({
  exercise,
  submission,
  isReviewing = false,
}: WritingExerciseSubmissionDetailsProps) {
...
export { WritingExerciseSubmissionDetails };
