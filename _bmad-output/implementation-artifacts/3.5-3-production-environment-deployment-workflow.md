...
- [x] 4.1 Create `.github/workflows/deploy-production.yml`:
...
- [x] 8.1 Create `packages/db/prisma/seed-production.ts`:
  - Create platform admin account only
  - Idempotent (safe to re-run)
- [x] 8.2 Add `db:seed:production` script to `packages/db/package.json`
