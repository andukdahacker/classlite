...
**Manual setup required (Tasks 4, 5, and parts of 6):**
- Create Railway project and configure services
- Create Firebase staging project
- Configure Railway deploy tokens as GitHub secrets
- Map environment variables in Railway dashboard
- Verify end-to-end staging deployment

**Tests:** 28 new infrastructure tests, 597 total backend tests passing, 523 webapp tests passing (1 pre-existing timing-sensitive failure in AssignmentCard.test.tsx unrelated to this story).
...
- 2026-02-11: Implemented code deliverables for Tasks 1, 2, 3, 6 (Dockerfiles, docker-compose, CI/CD workflow). Fixed pre-existing Prisma client-runtime-utils resolution issue. Tasks 4, 5 require manual cloud provider setup.
